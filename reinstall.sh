...
set -eE
confhome=https://raw.githubusercontent.com/chrimast/reinstall/main
confhome_cn=https://raw.githubusercontent.com/chrimast/reinstall/main
...
Manual: https://github.com/chrimast/reinstall
